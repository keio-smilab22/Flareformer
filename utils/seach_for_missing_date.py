...
def seach_for_representative_image(path_dir):
    ...
    for month in range(1, 13):
        ...
        # copy the file to a new directory
        path_origin = f'./data/noaa/magnetogram/{year}_5m/{month:02d}'
        path_save = f'./data/noaa/magnetogram/{year}/{month:02d}'
...
if __name__ == '__main__':
    ...
    seach_for_representative_image(dir_path)
