...
python main_informer.py --model FT --data Flare --des closed_test_ffill --batch_size 64 --feat_path data_all_v2_ffill.csv --lradj none --train_epochs 20 --learning_rate 1e-5
