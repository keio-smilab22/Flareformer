...
python main_informer.py --model FT --data Flare_sunpy --des mse --batch_size 16 --lradj none --train_epochs 20 --learning_rate 1e-6 --year 2018 --seq_len 12 --label_len 6 --attn full --root_path ./data/noaa --features S --pred_len 48
